...
//        GL11.glTranslatef(this.texture_width / 2.0F, this.texture_height / 2.0F, 0);
        ...
        drawModalRectWithCustomSizedTexture(-this.texture_width / 2.0F, this.texture_height / 2.0F, 0, 0, this.texture_width, -this.texture_height, this.texture_width, -this.texture_height);
